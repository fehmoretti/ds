...
export const theme = createTheme({
  ...
  components: {
    Button: { defaultProps: { radius: '${theme.components?.Button?.defaultProps?.radius ?? 'md'}' } },
    TextInput: { defaultProps: { radius: '${theme.components?.TextInput?.defaultProps?.radius ?? 'md'}' } },
    PasswordInput: { defaultProps: { radius: '${theme.components?.PasswordInput?.defaultProps?.radius ?? 'md'}' } },
    Textarea: { defaultProps: { radius: '${theme.components?.Textarea?.defaultProps?.radius ?? 'md'}' } },
    NumberInput: { defaultProps: { radius: '${theme.components?.NumberInput?.defaultProps?.radius ?? 'md'}' } },
    Select: { defaultProps: { radius: '${theme.components?.Select?.defaultProps?.radius ?? 'md'}' } },
    MultiSelect: { defaultProps: { radius: '${theme.components?.MultiSelect?.defaultProps?.radius ?? 'md'}' } },
    Card: { defaultProps: { radius: '${theme.components?.Card?.defaultProps?.radius ?? 'lg'}' } },
    Paper: { defaultProps: { radius: '${theme.components?.Paper?.defaultProps?.radius ?? 'lg'}' } },
    Modal: { defaultProps: { radius: '${theme.components?.Modal?.defaultProps?.radius ?? 'lg'}' } },
    Badge: { defaultProps: { radius: '${theme.components?.Badge?.defaultProps?.radius ?? 'xl'}' } },
    Pill: { defaultProps: { radius: '${theme.components?.Pill?.defaultProps?.radius ?? 'xl'}' } },
    ActionIcon: { defaultProps: { radius: '${theme.components?.ActionIcon?.defaultProps?.radius ?? 'md'}' } },
  },
});
`;
}
